...
public object DrawThemeFactory {
    ...
    public fun fromColors(colors: List<String>): DrawTheme {
        ...
        return DrawTheme(
            ...
            cardColor = if (mode == DrawThemeMode.LIGHT) Color.WHITE.withAlpha(0.65f) else Color.makeRGB(19, 23, 31).withAlpha(0.3f),
            borderColor = if (mode == DrawThemeMode.LIGHT) Color.WHITE.withAlpha(0.88f) else Color.WHITE.withAlpha(0.2f),
            textColor = if (mode == DrawThemeMode.LIGHT) Color.BLACK.withAlpha(0.85f) else Color.WHITE.withAlpha(0.85f),
