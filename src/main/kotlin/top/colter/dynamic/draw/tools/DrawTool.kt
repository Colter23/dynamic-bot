...
fun loadResourceBytes(path: String, name: String): ByteArray? {
    return try {
...
fun loadResourceImage(path: String = "image", name: String): Image? {
 ...
 */
fun loadResourceSVG(path: String, name: String): SVGDOM? {
 ...
 */
fun loadRenderSVG(path: String, name: String, width: Int = 100, height: Int = 100): Image? {
