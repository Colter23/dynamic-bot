            ...
            get("/deliveries") {
                ...
                call.respondApi {
                    context.service.deliveries(
                        ...
                        messageKind = call.request.queryParameters["messageKind"],
                        messageImportance = call.request.queryParameters["messageImportance"],
                        messageVisibility = call.request.queryParameters["messageVisibility"],
                        messageRecordPolicy = call.request.queryParameters["messageRecordPolicy"],
                        sinkRouteId = call.request.queryParameters["sinkRouteId"],
                        sinkAccountId = call.request.queryParameters["sinkAccountId"],
